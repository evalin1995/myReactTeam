...
import "../assets/css/privacy.min.css";
      ...
      <div className="container">
        ...
        <ContentBox>
          ...
          <Section
            ...
            content={
              <>
                為了提供您最佳的服務，本網站會在您的電腦中放置並取用我們的 Cookie，若您不願接受
                Cookie
...
const Header = () => (
  <div className="header">
    非常歡迎您光臨「HAPPY WORK共享辦公室」網站（以下簡稱本網站），為了讓您能夠安心的使用本網站的
    <br />
    各項服務與資訊，特此向您說明本網站的隱私權保護政策，以保障您的權益，請您詳閱下列內容：
  </div>
);

const ContentBox = ({ children }) => <div className="content-box">{children}</div>;
